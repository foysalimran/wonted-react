          ...
          <div className="col-lg-6 m-0px-b md-m-30px-b">
            <div className="hero__content position-relative">
              ...
              {/* <form action="#" id="subscribe-mailchimp" data-wow-duration="1.5s">
                    ...
                    <div className="result">
                        <p className="success-msg" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800"><i className="icofont-check"></i> You email has been stored!</p>
                        <p className="error-msg" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="850"><i className="icofont-close"></i> Sorry! Something went wrong!</p>
                    </div>
                  </form> */}
            </div>
          </div>
            ...
            <div className="hero__images text-center">
              ...
              <div className="hero__images--badge">
                <span>
                  ...
                  <span className="hero__images--badge--text2">best seller</span>
                </span>
              </div>
            </div>
          </div>
